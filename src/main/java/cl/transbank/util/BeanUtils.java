...
public class BeanUtils {
    ...
    public <T> T copyBeanData(T dest, Object source) throws IntrospectionException, InvocationTargetException, IllegalAccessException, InstantiationException, NoSuchMethodException {
        if (null == source)
            source = this;
