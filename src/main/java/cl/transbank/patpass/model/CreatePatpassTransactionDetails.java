...
public class CreatePatpassTransactionDetails {
    private List<Detail> detailList = new ArrayList<>();

    private CreatePatpassTransactionDetails() {}

    public static CreatePatpassTransactionDetails build() {
        return new CreatePatpassTransactionDetails();
    }
    ...
    public static CreatePatpassTransactionDetails build(
        ...
        return CreatePatpassTransactionDetails.build().add(
    ...
    public CreatePatpassTransactionDetails add(
            String serviceId, String cardHolderId, String cardHolderName, String cardHolderLastName1, String cardHolderLastName2,
            String cardHolderMail, String cellphoneNumber, String expirationDate, String commerceMail, boolean ufFlag) {
